...
![Создание виртуальной машины](image/lab01-1.png){#fig:0 width=70%}

Настраиваю виртуальную машину ([рис. @fig:lab01-2])
![Настройка виртуальной машины](image/lab01-2.png){#fig:0 width=70%}

Добавляю ISO файл ([рис. @fig:lab01-3])
![Добавили ISO файл](image/lab01-3.png){#fig:0 width=70%}

Запускаю liveinst ([рис. @fig:lab01-4])
![Запустили liveinst](image/lab01-4.png){#fig:0 width=70%}
...
![Загрузка development-tools](image/lab01-5.png){#fig:0 width=70%}
![Скачиваем фреймворк Linux](image/lab01-6.png){#fig:0 width=70%}
...
![Монтируем диск](image/lab01-7.png){#fig:0 width=70%}
![Устанавливаем драйвера](image/lab01-8.png){#fig:0 width=70%}
![Выполняем перезагрузку машины](image/lab01-9.png){#fig:0 width=70%}
![Добавляем пользователя в группу vboxsf](image/lab01-10.png){#fig:0 width=70%}
![Создание папки work](image/lab01-11.png){#fig:0 width=70%}
![Проверка добавления папки work](image/lab01-12.png){#fig:0 width=70%}

Выполняем reboot, заходим в режим суперпользователя и обновляем пакеты ([рис. @fig:lab01-13])

![Обновляем пакеты](image/lab01-13.png){#fig:0 width=70%}

Скачиваем программы для удобства работы в консоли [рис. @fig:lab01-14],[рис. @fig:lab01-15],[рис. @fig:lab01-16]()

![Устанавливаем tmux](image/lab01-14.png){#fig:0 width=70%}
![Устанавливаем kitty](image/lab01-15.png){#fig:0 width=70%} 
![Делаем установку программного обеспечения](image/lab01-16.png){#fig:0 width=70%}
...
![Задали конфигурацию в файле](image/lab01-17.png){#fig:0 width=70%}
![Заполнили файл согласно инструкции](image/lab01-18.png){#fig:0 width=70%}
![Запустили таймер](image/lab01-19.png){#fig:0 width=70%}
![Перешли в файл /etc/selinux/config для редактирования](image/lab01-20.png){#fig:0 width=70%}
![Сменили SELINUX=enforcing на SELINUX=permissive](image/lab01-21.png){#fig:0 width=70%}
![Делаем перезагрузку](image/lab01-22.png){#fig:0 width=70%}
![Создаём конфигурационный файл и заходим в редактирование](image/lab01-23.png){#fig:0 width=70%}
![Заполняем файл](image/lab01-24.png){#fig:0 width=70%}
![Проверяем правильность заполнения файла](image/lab01-25.png){#fig:0 width=70%}

Редактируем конфигурационный файл /etc/X11/xorg.conf.d/00-keyboard.conf ([рис. @fig:lab01-26, [рис. @fig:lab01-27])

![Настраиваем опции](image/lab01-26.png){#fig:0 width=70%}
![Выполняем перезагрузку](image/lab01-27.png){#fig:0 width=70%}
...
![Обновление пароля](image/lab01-28.png){#fig:0 width=70%}
![Устанавливаем имя хоста](image/lab01-29.png){#fig:0 width=70%}
![Устанавливаем пакеты для pandoc](image/lab01-30.png){#fig:0 width=70%}
![Узнаём версию pandoc ](image/lab01-31.png){#fig:0 width=70%}

Далее переходим в github и скачиваем нужную версию pandoc ([рис. @fig:lab01-32], [рис. @fig:lab01-33)

![Скачиваем pandoc](image/lab01-32.png){#fig:0 width=70%}
![Разархивируем файл с pandoc, загружаем texlive](image/lab01-33.png){#fig:0 width=70%}

# **Выполнение домашней работы**

1) Получаем версию линукса и узнаем частоту процессора ([рис. @fig:lab01-34)
![Получаем версию Линукса, узнаём частоту процессора](image/lab01-34.png){#fig:0 width=70%}

2) Выводим данные о процессоре ([рис. @fig:lab01-35])
![Выводим данные о процессоре](image/lab01-35.png){#fig:0 width=70%}

3) Выводим информацию об использовании оперативной памяти ([рис. @fig:lab01-36)
![Информация об использовании оперативной памяти (RAM)](image/lab01-36.png){#fig:0 width=70%}

4) Выводим информацию о гипервизоре ([рис. @fig:lab01-37)
![Информация о гипервизоре](image/lab01-37.png){#fig:0 width=70%}

5) Выводим информацию о типе файловой системы корневого раздела ([рис. @fig:lab01-38)
![Тип файловой системы корневого раздела](image/lab01-38.png){#fig:0 width=70%}

6) Выводим информацию о последовательности монтирования файловых систем ([рис. @fig:lab01-39)
![Последовательность монтирования файловых систем](image/lab01-39.png){#fig:0 width=70%}
